...
public class YourGifGridAdapter extends RecyclerView.Adapter<YourGifGridAdapter.ViewHolder> {
    ...
    public YourGifGridAdapter(Context activity, boolean isYourGif) {
        ...
        getAllShownImagesPath((Activity) activity, isYourGif, ".gif");
    }
    ...
    private void getAllShownImagesPath(final Activity activity, final boolean isYourGif, final String typeFile) {
        new AsyncTask<Void, Void, ArrayList<String>>() {
            ...
            @Override
            protected void onPostExecute(ArrayList<String> listArrImage) {
                super.onPostExecute(listArrImage);
                paths = listArrImage;
                onYourGifAdapterChanged.OnFinish();
            }
        }.execute();
    }
}